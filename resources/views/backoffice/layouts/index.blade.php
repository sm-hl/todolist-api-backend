...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'dark text-bodydark bg-boxdark-2': darkMode === true }">
    <!-- ===== Preloader Start ===== -->
    @include('backoffice.partials.preloader')
            ...
            <main>
                <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
                    ...
                    <div class="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
                        <!-- ====== Chart One Start -->
                        @include('backoffice.partials.chart-01')
                        {{-- <include src="./partials/chart-01.html" /> --}}
                        <!-- ====== Chart One End -->

                        <!-- ====== Chart Two Start -->
                        @include('backoffice.partials.chart-02')
                        {{-- <include src="./partials/chart-02.html" /> --}}
                        <!-- ====== Chart Two End -->

                        <!-- ====== Chart Three Start -->
                        @include('backoffice.partials.chart-03')
                        {{-- <include src="./partials/chart-03.html" /> --}}
                        <!-- ====== Chart Three End -->

                        <!-- ====== Map One Start -->
                        @include('backoffice.partials.map-01')
                        {{-- <include src="./partials/map-01.html" /> --}}
                        <!-- ====== Map One End -->

                        <!-- ====== Table One Start -->
                        <div class="col-span-12 xl:col-span-8">
                            @include('backoffice.partials.table-01')
